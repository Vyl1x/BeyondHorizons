...
public class AmuletOfTheTiger extends Item {
    ...
    boolean ActiveTime;
    public AmuletOfTheTiger(FabricItemSettings fabricItemSettings) {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        user.addStatusEffect(new StatusEffectInstance(ModStatusEffects.EFFECT_OF_THE_TIGER, 45 * 20, 1), user);
