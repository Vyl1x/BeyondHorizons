...
public enum ModToolMaterials implements ToolMaterial {
    ...
    Ruby(ModTags.Blocks.INCORRECT_FOR_RUBY_TOOL, 784, 12.5F, 2F, 21, () ->
            Ingredient.ofItems(ModItems.RUBY)),

    Enderite(ModTags.Blocks.INCORRECT_FOR_ENDERITE_TOOL, 1974, 10.5F, 2.5F, 27, () ->
            Ingredient.ofItems(ModItems.ENDERITE_INGOT)),

    Phoenixite(ModTags.Blocks.INCORRECT_FOR_PHOENIXITE_TOOL, 1841, 10.0F, 3.0F, 27, () ->
            Ingredient.ofItems(ModItems.PHOENIXITE_INGOT)),

    Celestite(ModTags.Blocks.INCORRECT_FOR_CELESTITE_TOOL, 2133, 11.0F, 3.0F, 27, () ->
            Ingredient.ofItems(ModBlocks.CELESTITE_BLOCK)),

    Cobalt(ModTags.Blocks.INCORRECT_FOR_COBALT_TOOL, 1306, 10.0F, 2.0F, 24, () ->
            Ingredient.ofItems(ModItems.COBALT_INGOT)),

    Mythril(ModTags.Blocks.INCORRECT_FOR_MYTHRIL_TOOL, 1923, 10.0F, 2.0F, 24, () ->
            Ingredient.ofItems(ModItems.MYTHRIL_INGOT)),

    CobaltMT(ModTags.Blocks.INCORRECT_FOR_COBALTMT_TOOL, 5000, 13F, 3.0F, 27, () ->
