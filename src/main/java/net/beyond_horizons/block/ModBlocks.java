...
import net.beyond_horizons.world.feature.tree.gen.*;
...
public class ModBlocks {
    ...
    public static final Block NIGHTSHADEGROVE_LOG = registerBlocks("nightshadegrove_log",
            new PillarBlock(FabricBlockSettings.copyOf(Blocks.OAK_LOG).strength(2.0F, 4.0F)));
    ...
    public static final Block STRIPPED_NIGHTSHADEGROVE_LOG = registerBlocks("stripped_nightshadegrove_log",
            new PillarBlock(FabricBlockSettings.copyOf(Blocks.STRIPPED_OAK_LOG).strength(2.0F, 4.0F)));
    ...
    public static final Block NIGHTSHADEGROVE_WOOD = registerBlocks("nightshadegrove_wood",
            new PillarBlock(FabricBlockSettings.copyOf(Blocks.OAK_WOOD).strength(2.0F, 4.0F)));
    ...
    public static final Block STRIPPED_NIGHTSHADEGROVE_WOOD = registerBlocks("stripped_nightshadegrove_wood",
            new PillarBlock(FabricBlockSettings.copyOf(Blocks.STRIPPED_OAK_WOOD).strength(2.0F, 4.0F)));
    ...
    public static final Block NIGHTSHADEGROVE_STAIRS = registerBlocks("nightshadegrove_stairs",
            new ModStairsBlock(OAK_PLANKS.getDefaultState(),FabricBlockSettings.copyOf(Blocks.OAK_STAIRS).strength(2.0F, 4.0F)));
    ...
    public static final Block NIGHTSHADEGROVE_SLAB = registerBlocks("nightshadegrove_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.OAK_SLAB).strength(2.0F, 4.0F)));
    ...
    public static final Block NIGHTSHADEGROVE_PRESSURE_PLATE = registerBlocks("nightshadegrove_pressure_plate",
            new ModPressurePlateBlock(EVERYTHING, FabricBlockSettings.copyOf(Blocks.OAK_PRESSURE_PLATE).strength(2.0F, 4.0F)
    ...
    public static final Block NIGHTSHADEGROVE_BUTTON = registerBlocks("nightshadegrove_button",
            new ModButtonBlock(FabricBlockSettings.copyOf(Blocks.OAK_BUTTON).strength(2.0F, 4.0F),
    ...
    public static final Block NIGHTSHADEGROVE_FENCE = registerBlocks("nightshadegrove_fence",
            new FenceBlock(FabricBlockSettings.copyOf(Blocks.OAK_FENCE).strength(2.0F, 4.0F)));
    ...
    public static final Block NIGHTSHADEGROVE_FENCE_GATE = registerBlocks("nightshadegrove_fence_gate",
            new FenceGateBlock(FabricBlockSettings.copyOf(Blocks.OAK_FENCE_GATE).strength(2.0F, 4.0F), WoodType.OAK));
    ...
    public static final Block NIGHTSHADEGROVE_PLANKS = registerBlocks("nightshadegrove_planks",
            new Block(FabricBlockSettings.copyOf(Blocks.OAK_PLANKS).strength(2.0F, 4.0F)));
    ...
    public static final Block NIGHTSHADEGROVE_DOOR = registerBlocks("nightshadegrove_door",
            new DoorBlock(FabricBlockSettings.copyOf(Blocks.OAK_DOOR).strength(2.0F, 4.0F), BlockSetType.OAK));
    ...
    public static final Block NIGHTSHADEGROVE_TRAPDOOR = registerBlocks("nightshadegrove_trapdoor",
            new TrapdoorBlock(FabricBlockSettings.copyOf(Blocks.OAK_TRAPDOOR).strength(2.0F, 4.0F), BlockSetType.OAK));
    ...
    public static final Block NIGHTSHADEGROVE_LEAVES = registerBlocks("nightshadegrove_leaves",
            new LeavesBlock(FabricBlockSettings.copyOf(Blocks.OAK_LEAVES).strength(0.2F, 4.0F)));
    ...
    public static final Block NIGHTSHADEGROVE_SAPLING = registerBlocks("nightshadegrove_sapling",
            new ModSaplingBlock(new NightShadeGroveSapplingGenerator(),
                    FabricBlockSettings.copyOf(Blocks.OAK_SAPLING), () -> ModBlocks.NIGHTSHADEGROVE_END_STONE));
    public static final Block JUNGLEJADE_SAPLING = registerBlocks("junglejade_sapling",
            new SaplingBlock(new JungleJadeSapplingGenerator(),
                    FabricBlockSettings.copyOf(Blocks.OAK_SAPLING)));
    public static final Block CRYSTALASPEN_SAPLING = registerBlocks("crystalaspen_sapling",
            new SaplingBlock(new CrystalAspenSapplingGenerator(),
                    FabricBlockSettings.copyOf(Blocks.OAK_SAPLING)));
    public static final Block SHADOWONYXBLOODFLAME_SAPLING = registerBlocks("shadowonyxbloodflame_sapling",
            new SaplingBlock(new ShadowOnyxBloodFlameSapplingGenerator(),
                    FabricBlockSettings.copyOf(Blocks.OAK_SAPLING)));
    public static final Block DARKFIRE_SAPLING = registerBlocks("darkfire_sapling",
            new SaplingBlock(new DarkFireSapplingGenerator(),
                    FabricBlockSettings.copyOf(Blocks.OAK_SAPLING)));

    /** ENDSTONE **/
    public static final Block NIGHTSHADEGROVE_END_STONE = registerBlocks("nightshadegrove_end_stone",
            new SpreadableBlock(FabricBlockSettings.copyOf(Blocks.END_STONE).strength(0.2F, 4.0F).requiresTool()) {
            });


    /** ORES **/
    public static final Block DEEPSLATE_RUBY_ORE = registerBlocks("deepslate_ruby_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.copyOf(Blocks.DEEPSLATE).strength(4.5f, 3.0f).requiresTool(),
                    UniformIntProvider.create(2, 6)));
    public static final Block RUBY_ORE = registerBlocks("ruby_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.copyOf(Blocks.STONE).strength(3.0f, 3.0F).requiresTool(),
                    UniformIntProvider.create(2, 6)));
    public static final Block PHOENIXITE_ORE = registerBlocks("phoenixite_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.copyOf(Blocks.NETHERRACK).strength(6.35F, 12000.0F).requiresTool(),
                    UniformIntProvider.create(2, 6)));
    public static final Block ENDERITE_ORE = registerBlocks("enderite_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.copyOf(Blocks.END_STONE).strength(6.35F, 12000.0F).requiresTool(),
                    UniformIntProvider.create(2, 6)));
    public static final Block ENDERITE_COAL_ORE = registerBlocks("enderite_coal_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.copyOf(Blocks.END_STONE).strength(3.25F, 3.0F).requiresTool(),
                    UniformIntProvider.create(2, 6)));
    public static final Block CELESTITE_ORE = registerBlocks("celestite_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.copyOf(Blocks.END_STONE).strength(12.0F, 12000.0F).requiresTool(),
                    UniformIntProvider.create(2, 6)));
    public static final Block COBALT_ORE = registerBlocks("cobalt_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.copyOf(Blocks.STONE).strength(3.25F, 3.0F).requiresTool(),
                    UniformIntProvider.create(2, 6)));
    public static final Block DEEPSLATE_COBALT_ORE = registerBlocks("deepslate_cobalt_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.copyOf(Blocks.DEEPSLATE).strength(3.25F, 3.0F).requiresTool(),
                    UniformIntProvider.create(2, 6)));
    public static final Block MYTHRIL_ORE = registerBlocks("mythril_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.copyOf(Blocks.STONE).strength(5.0F, 12.0F).requiresTool(),
                    UniformIntProvider.create(2, 6)));
    public static final Block DEEPSLATE_MYTHRIL_ORE = registerBlocks("deepslate_mythril_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.copyOf(Blocks.DEEPSLATE).strength(6.0F, 12.0F).requiresTool(),
                    UniformIntProvider.create(2, 6)));

    /** BLOCKS **/
    public static final Block RUBY_BLOCK = registerBlocks("ruby_block",
            new Block(FabricBlockSettings.copyOf(Blocks.IRON_BLOCK).nonOpaque().strength(4.0F, 4.0F).requiresTool()));
    ...
    public static final Block PHOENIXITE_BLOCK = registerBlocks("phoenixite_block",
            new Block(FabricBlockSettings.copyOf(Blocks.IRON_BLOCK).nonOpaque().strength(6.0F, 4.0F).requiresTool()));
    ...
    public static final Block CELESTITE_BLOCK = registerBlocks("celestite_block",
            new Block(FabricBlockSettings.copyOf(Blocks.IRON_BLOCK).nonOpaque().strength(12.0F, 4.0F).requiresTool()));
    public static final Block MYTHRIL_BLOCK = registerBlocks("mythril_block",
            new Block(FabricBlockSettings.copyOf(Blocks.IRON_BLOCK).nonOpaque().strength(6.0F, 4.0F).requiresTool()));

    private static Block registerBlocks(String name, Block block) {
        registerBlockItem(name, block);
        return Registry.register(Registries.BLOCK, new Identifier(BeyondHorizons.MOD_ID, name), block);
    }

    private static void registerBlockItem(String name, Block block) {
        Item item = Registry.register(Registries.ITEM, new Identifier(BeyondHorizons.MOD_ID, name),
